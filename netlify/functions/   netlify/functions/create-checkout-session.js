...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Construit les lignes de commande Stripe à partir du panier envoyé
    // par le navigateur. Le prix est recalculé ici en centimes ; pensez à
    // brancher ceci sur votre vrai catalogue (base de données) plutôt que
    // de faire confiance aux prix envoyés par le client, une fois que vous
    // aurez de vrais produits en vente.
